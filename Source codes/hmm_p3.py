...
root_dir = "./"
# As for part3, We need to find the 5th best sequence instead of the best, the vertibi is modified such that we only get the 5th best throughout the algorithm
...
#Viterbi
def modifiedviterbi(emission_dict, transition_dict, observations, sentence):
    n = len(sentence)
    smallest = -9999
    ...
    #agmax of y, only the 5th best sequence
    stop_max5 = stop_max[:]
    stop_max5.sort()
    stop = stop_max5[2]
    ...
    for i in datasets:
        ...
        for line in lines:        
            if line != "\n":
                ...
                sentence_predict = modifiedviterbi(track_emission, track_transition, all_tokens, sentence)
